      ...
      .subscribe((data) => {
        ...
        friendIds.forEach((id) => {
          ...
          .subscribe((data) => {
            ...
            data.forEach((cat) => {
              console.log(cat, "AHAHAHAHAHAHA &^&$^&^&#^&@^@&^@&^@")
              this.categoryService.getCategoryById(cat.category_id)
              .subscribe((data) => {
                console.log(data, "DAAAAAMAN PLEAAASEEE HAHAHAHAHAHAHA")
                this.cats.push(data[0].name);
